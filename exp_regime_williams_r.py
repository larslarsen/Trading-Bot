...
"""Regime fallback: d40 trending -> Williams %R choppy."""
import sys
...
print("regime fallback d40->williams_r (full)", flush=True)
res_reg = run_regime(full_dates, price_df, sig_d40, sig_entry, sig_exit, realized_vol)
print("regime_d40_williams_r full: ret=" + str(round(res_reg["return_pct"], 1)) + "% sharpe=" + str(round(res_reg["sharpe"], 2)) + " dd=" + str(round(res_reg["max_dd_pct"], 1)) + "% trades=" + str(res_reg["trades"]), flush=True)

print("regime fallback d40->williams_r (90d)", flush=True)
...
print("regime_d40_williams_r 90d: ret=" + str(round(res_reg90["return_pct"], 1)) + "% sharpe=" + str(round(res_reg90["sharpe"], 2)) + " dd=" + str(round(res_reg90["max_dd_pct"], 1)) + "% trades=" + str(res_reg90["trades"]), flush=True)
